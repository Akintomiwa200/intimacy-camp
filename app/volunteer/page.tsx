...
type Step = {
  ...
  return baseSteps;
    ...
    const DEPARTMENTS = [
        { id: "media", name: "Media & Photography" },
        { id: "protocol", name: "Protocol & Ushering" },
        { id: "logistics", name: "Logistics & Operations" },
        { id: "welfare", name: "Welfare & Hospitality" },
        { id: "technical", name: "Technical & Sound" },
        { id: "security", name: "Security" },
        { id: "registration", name: "Registration & Admin" },
        { id: "prayer", name: "Prayer Team" },
        { id: "creative", name: "Creative & Decorations" },
        { id: "medical", name: "Medical Team" },
    ];
  ...
  setFormData((prev) => {
    ...
    if (currentDepts.includes(deptId)) {
      return { ...prev, departments: currentDepts.filter(id => id !== deptId) };
    }

    if (currentDepts.length < 2) {
      return { ...prev, departments: [...currentDepts, deptId] };
    }
                    ...
                    {step.id === 5 && (
                        <div>
                            ...
                            <p className="text-sm text-gray-500 mb-4">
                                Select up to 2 departments you'd like to volunteer for
                            </p>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                {DEPARTMENTS.map((dept) => {
                                    const isSelected = formData.departments.includes(dept.id);
                                    const canSelect = formData.departments.length < 2 || isSelected;
                            ...
                            {formData.departments.length > 0 && (
                                <p className="text-sm text-purple-600 mt-3">
                                    {formData.departments.length} of 2 departments selected
                                </p>
                            )}
                        </div>
                    )}
